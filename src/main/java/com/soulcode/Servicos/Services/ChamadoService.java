...
public class ChamadoService {
    ...
    // vamos editar os dados do chamado, mas continuamos com os dados do cliente e os dados do funcionario
    ...
    //-> regra -> no momento em que um determinado chamado é atribuído a um funcionário o status do chamado precisa ser alterado para ATRIBUIDO
