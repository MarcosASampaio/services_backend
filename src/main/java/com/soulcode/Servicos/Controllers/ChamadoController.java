...
public class ChamadoController {
    ...
    @GetMapping("/chamados")
    public List<Chamado> mostrarTodosChamado(){
    ...
    public List<Chamado> buscarPorIntervaloData(@RequestParam("data1") @DateTimeFormat(iso = DateTimeFormat.ISO.DATE) Date data1, @RequestParam("data2") @DateTimeFormat(iso = DateTimeFormat.ISO.DATE) Date data2){
